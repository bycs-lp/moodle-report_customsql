...
$string['customsql:usecustomsql'] = 'Discover queries through the Custom SQL webservice';
$string['customsql:view'] = 'View custom queries report';
$string['customsql:viewallexecutions'] = 'View all query executions';
$string['customsqlcategories'] = 'Available Custom SQL categories';
$string['customsqlcategoriesdesc'] = 'Select the categories whose query names can be retrieved through the webservice.';
$string['customsqlgraphitepath'] = 'Graphite path for {$a}';
$string['customsqlgraphitepathdesc'] = 'The Graphite path returned for queries in category "{$a}".';
$string['customsqlgraphitepaths'] = 'Graphite paths for Custom SQL categories';
$string['customsqlgraphitepathsdesc'] = 'Save the category selection first, then configure the Graphite path for each selected category.';
$string['customsqlwebservice'] = 'Custom SQL query discovery webservice';
$string['customsqlwebservicedesc'] = 'Settings for the webservice that lists query names and their category Graphite paths.';
